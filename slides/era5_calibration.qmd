...
format: 
  beamer:
    ...
    slide-level: 2
    split-bib: true
    output-file: "era5_calibration_slides_26-01-13.pdf"
header-includes:
  - \usepackage{graphicx}
fontsize: 12pt
aspectratio: 169
...
### 4. Calibration of generic power curve estimate
...
\includegraphics[width=\linewidth,height=5cm,keepaspectratio]{../fig/gb_calib_lm0_hexbin_all.pdf}
:::
...
\centering
\small Calibration comparison
\includegraphics[width=\linewidth,height=5cm,keepaspectratio]{../fig/gb_calib_lm_hexbin_all.pdf}
:::
...
\centering
\small Calibration comparison
\includegraphics[width=\linewidth,height=5cm,keepaspectratio]{../fig/gb_calib_lar1_hexbin_all.pdf}
:::
...
- Wind direction effects on power curve
- Compare model against benchmarks: Quantile mapping
- Add CRPS and coverage metrics
- Spatiotemporal calibration model
- Write introduction and methods
  - References of applications of the 1D SPDE
  - References for cut-off estimation
