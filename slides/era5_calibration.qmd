...
\tilde{P}_i \mid \eta^{(\beta)}_{i}
  &\sim \mathcal{N}\!\left(
    ...
    \right),
  \qquad
    \tau_{\mathrm{ps}} = \texttt{pseudo\_precision}.
\end{align}
...
\includegraphics[width=\linewidth,height=5cm,keepaspectratio]{../fig/ZIBspdePen1_24_wfsamp_curve.pdf}
:::
...
\includegraphics[width=\linewidth,height=5cm,keepaspectratio]{../fig/ZIBspdePen1_24_wfsamp_zeroProb.pdf}
...
\includegraphics[width=\linewidth,height=5cm,keepaspectratio]{../fig/ZIBspdePen1_24_wfsamp_hyper.pdf}
:::
