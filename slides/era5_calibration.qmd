...
- Updated power curve comparison to data
- ERA 5 wind speed conversion to power

### Next steps
- Learn power curve from data
- Benchmark models: Quantile mapping, GAMs
- Calibration spatiotemporal model

## ERA5 vs Elexon generation
\small Calibrate a ERA5 driven estimate to \textbf{potential generation} accounting for spatiotemporal properties.

\vspace{0.2cm}
\begin{columns}[T, totalwidth=\textwidth]
  \begin{column}{0.5\textwidth}
    \centering
    \small{\small ERA5 at wind farms}\\[0.5em]
    \includegraphics[width=\linewidth,height=4cm,keepaspectratio]{../fig/era5_at_windfarms.eps}
   
  \end{column}

  \begin{column}{0.5\textwidth}
    \centering
    \small{\small Elexon wind farms map (2025)}\\[0.5em]
    \vspace{-0.2cm}
    \includegraphics[width=\linewidth,height=4cm,keepaspectratio]{../fig/wind_farms_elexon_size_2025.pdf}
  \end{column}
\end{columns}
\tiny Closest grid point to each wind farm location
...
## Comparison for all wind farms
::: {.columns}

::: {.column width="50%"}
\begin{itemize}
  \item Working with 2024 data only
  \item Each point represents one hour and one location 
  \item Showin a sample of points to simplify plotting
\end{itemize}
:::

::: {.column width="50%"}
\centering
    \small Scatter all wind farms
    \includegraphics[width=\linewidth,height=5cm,keepaspectratio]{../fig/pc_scatter_all.pdf}
:::

:::

# GB level aggregation {#sec:gb_aggr}
...
## Density of aggregated power
::: {.columns}

::: {.column width="50%"}
- Cut-off wind speed isn't capture well by generic power curves
- This issue is markedly present in offshore data
:::

::: {.column width="50%"}
\centering
\small Density of Elexon and ERA5 based estimate
\includegraphics[width=\linewidth,height=5cm,keepaspectratio]{../fig/density_comparison_all.pdf}
:::

:::
## Power curve by season
...
\centering
\small Power curve
\includegraphics[width=\linewidth,height=5cm,keepaspectratio]{../fig/pc_bindens_GB_valnout_all.png}
:::

::: {.column width="50%"}
\centering
\small Power curve by season
\includegraphics[width=\linewidth,height=5cm,keepaspectratio]{../fig/pc_bindens_GB_valnout_month_all.png}
:::

:::


## Linear calibration by season
...
\centering
\small Onshore power
\includegraphics[width=\linewidth,height=5cm,keepaspectratio]{../fig/gb_aggr_scatter_on_month_all.png}
:::

::: {.column width="50%"}
\centering
\small Offshore power
\includegraphics[width=\linewidth,height=5cm,keepaspectratio]{../fig/gb_aggr_scatter_off_month_all.png}
:::

:::

## Difference in density by season
...
\centering
\small Onshore power
\includegraphics[width=\linewidth,height=5cm,keepaspectratio]{../fig/cf_density_comparison_on_month_all.pdf}
:::

::: {.column width="50%"}
\centering
\small Offshore power
\includegraphics[width=\linewidth,height=5cm,keepaspectratio]{../fig/cf_density_comparison_off_month_all.pdf}
:::

:::

## Linear calibration by time of day
...
\centering
\small Onshore power
\includegraphics[width=\linewidth,height=5cm,keepaspectratio]{../fig/gb_aggr_scatter_on_hour_all.png}
:::

::: {.column width="50%"}
\centering
\small Offshore power
\includegraphics[width=\linewidth,height=5cm,keepaspectratio]{../fig/gb_aggr_scatter_off_hour_all.png}
:::

:::

## Difference in density by hour
...
\centering
\small Onshore power
\includegraphics[width=\linewidth,height=5cm,keepaspectratio]{../fig/cf_density_comparison_on_hour_all.pdf}
:::

::: {.column width="50%"}
\centering
\small Offshore power
\includegraphics[width=\linewidth,height=5cm,keepaspectratio]{../fig/cf_density_comparison_off_hour_all.pdf}
:::
