...
Using a two-likelihood approach for power curve estimation:

- **1st likelihood:** Observed power is modelled as a smooth function of wind speed
  - Random walk of order 2
  - Beta with logit link for output [0,1]  


:::

::: {.column width="50%"}
- **2nd likelihood:** Penalisation towards a generic PC
  - Gaussian noise; strength controlled via precision
  - Estimate is pulled to typical turbine behaviour  

- **Cut-off speed estimation?** 

- **Outcome:** Smooth, physically realistic power curve informed by both data and prior knowledge
