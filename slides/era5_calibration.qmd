...
For each location $i$ we have: observed power $p_i$, number of turbines $n_i$, turbine capacity $c_i$, turbine height $v_i$, and wind speed $w_i$.
...
\begin{equation*}
    \tilde p_i = \widetilde \text{PC}_{k} (w_{i}) \times n_{i}
\end{equation*}

## Generic power curves vs observed data - Fall Rig
\begin{columns}[T, totalwidth=\textwidth]
