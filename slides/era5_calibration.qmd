...
::: {.column width="50%"}
\small Variogram for Elexon generation

\includegraphics[width=\linewidth,height=5cm,keepaspectratio]{../fig/variogram_norm_power.pdf}
:::

::: {.column width="50%"}
\small Variogram for ERA5 uncalibrated estimate

\includegraphics[width=\linewidth,height=5cm,keepaspectratio]{../fig/variogram_norm_power_est.pdf}
:::
