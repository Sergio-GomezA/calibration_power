...
format: 
  beamer:
    ...
    slide-level: 2
    split-bib: true
    output-file: "era5_calibration_intro.pdf"
header-includes:
  - \usepackage{graphicx}
fontsize: 12pt
aspectratio: 169
...
- Non-stationarity 
  ...
  - anomaly detection: outatges, curtailment 
- Physically informed model 
- Data dimensionality reduction
- Simultaneous calibration of:
  - wind / temperature / precipitation / GHI
  - targeting renewables generation and energy demand
