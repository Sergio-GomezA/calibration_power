...
- [x] Figures and scores with only 24 / 12 H
- [x] Figures with prediction for anomalies
- [ ] summary interval width (scores) 
- [x] anomalies percentage (distribution on days)(pwr_curv_df)
- [ ] RMSE check
