...
# ggsave(
#   sprintf(
#     "%s/fig/%s_sim_field_%s_range%d_sd%s.pdf",
#     batch_name,
#     prefix,
#     d0_tag,
#     true_range,
...
ggsave(
  sprintf(
    "%s/fig/%s_sim_obs_vs_true_%s_range%d_sd%s.pdf",
    batch_name,
    prefix,
    d0_tag,
    true_range,
...
ggsave(
  sprintf(
    "%s/fig/%s_fitted_vs_observed_%s_range%d_sd%s.pdf",
    batch_name,
    prefix,
    d0_tag,
    true_range,
...
# ggsave(
#   sprintf(
#     "%s/fig/%s_est_field_%s_range%d_sd%s.pdf",
#     batch_name,
#     prefix,
#     d0_tag,
#     true_range,
...
# ggsave(
#   sprintf(
#     "%s/fig/%s_est_field_%s_range%d_sd%s_ci.pdf",
#     batch_name,
#     prefix,
#     d0_tag,
#     true_range,
